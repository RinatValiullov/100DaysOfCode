...
const init = () => {
  ...
  const source$ = new rxjs__WEBPACK_IMPORTED_MODULE_0__.Observable((observer) => {
    let index = 0;
    ...
    (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_1__.map)((letter) => {
      if (letter === "4") {
        return "F";
      }
      return letter.toUpperCase();
    }),
    (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.filter)((letter) => letter.charCodeAt(0) > 80)
  );
...
(0,_utils_app__WEBPACK_IMPORTED_MODULE_0__.init)();
